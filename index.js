...
// moviesDB.create({  title: "Jaws", year: 1975, rating: 8 },
...
app.get('/movies/read/by-date', (req, res) => {
    moviesDB.find().then(data => {
        res.status(200).json({ satus: 200, message: data.sort((a, b) => b.year - a.year) })
    })
})

app.get('/movies/read/by-rating', (req, res) => {
    moviesDB.find().then(data => {
        res.status(200).json({ satus: 200, message: data.sort((a, b) => b.rating - a.rating) })
    })
})
...
app.get('/movies/read/by-title', (req, res) => {
    moviesDB.find().then(data => {
        res.status(200).json({
            status: 200, message: data.sort((a, b) => {
